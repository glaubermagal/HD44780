...
var Code = function (_React$Component) {
    ...
    _createClass(Code, [{
        ...
        value: function render() {
            ...
            this.props.squares.map(function (value, index) {
                if ((index + 1) % 5 === 1) {
                    charLines += '    0b';
                }
                charLines += '' + value;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'table',
                    { className: 'liquid-crystal-settings' },
                    _react2.default.createElement(
                        'tbody',
                        null,
                        _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: 'https://www.arduino.cc/en/Reference/LiquidCrystal', target: '_blank' },
...
function Square(props) {
    var classes = (0, _classnames2.default)("square", {
        'selected': props.value
    });

    return _react2.default.createElement('button', { className: classes, onClick: props.onClick });
}
    ...
    _createClass(Board, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'display' },
                this.props.squares.map(function (square, index) {
                    return _this4.renderSquare(index);
                })
            );
        }
    }]);
...
var Game = function (_React$Component3) {
    ...
    function Game(props) {
        ...
        _this5.invert = _this5.invert.bind(_this5);
    ...
    _createClass(Game, [{
        ...
        value: function invert() {
            var squares = this.state.squares.map(function (value, index) {
                return value === 1 ? 0 : 1;
            });
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                'Character Generator for HD44780 LCD Modules'
                            ),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: 'https://github.com/glaubermagal', target: '_blank' },
                                'glaubermagal'
                            )
                        )
                    )
...
// module
exports.push([module.i, "body, html {\n  margin: 0;\n  font-family: 'VT323', monospace;\n  font-size: 16px;\n  color: #e0e0e0;\n  background: #111; }\n\nh1, h2, h3, h4, h5, h6, p, ul, strong, td, input, text {\n  margin: 0;\n  padding: 0; }\n\nul li {\n  list-style-type: none; }\n\n* {\n  box-sizing: border-box; }\n\n.game {\n  width: 100%;\n  max-width: 760px;\n  margin: auto;\n  padding-top: 20px;\n  padding-bottom: 20px; }\n  .game .board {\n    width: 125px;\n    float: left; }\n    .game .board .display {\n      display: inline-block;\n      padding: 10px;\n      background: #60a260;\n      line-height: 0; }\n    .game .board .square {\n      padding: 0;\n      margin: 0.5px;\n      width: 20px;\n      height: 20px;\n      background: #2c4408;\n      border: 0;\n      outline: 0;\n      cursor: pointer; }\n      .game .board .square.selected {\n        background: #a9f737; }\n  .game .output-code {\n    width: 100%;\n    width: calc(100% - 129px);\n    width: -webkit-calc(100% - 129px);\n    display: inline-block;\n    vertical-align: top;\n    margin-left: 4px; }\n  .game .border {\n    padding: 20px;\n    border: 2px dashed #60a260;\n    margin-bottom: 20px; }\n  .game .game-title {\n    font-size: 2.1rem;\n    text-transform: uppercase;\n    margin-bottom: 20px; }\n  .game code {\n    font-size: 12px; }\n  .game .btn {\n    display: block;\n    margin-top: 5px;\n    width: 125px;\n    font-size: 12px;\n    border: 1px solid #60a260;\n    background: #2c4408;\n    color: #e0e0e0;\n    text-transform: uppercase;\n    cursor: pointer; }\n    .game .btn:hover {\n      background: #5b8023; }\n  .game .liquid-crystal-settings {\n    font-family: 'Inconsolata', monospace;\n    width: 100%;\n    margin-bottom: 20px;\n    background: #333; }\n    .game .liquid-crystal-settings td {\n      padding: 6px; }\n    .game .liquid-crystal-settings input {\n      width: 40px;\n      padding: 4px;\n      font-size: 11px;\n      font-weight: bold;\n      background: #60a260;\n      border: 0; }\n  .game .credits {\n    font-size: 18px; }\n", ""]);
...
// module
exports.push([module.i, "/* PrismJS 1.15.0\nhttps://prismjs.com/download.html#themes=prism-okaidia&languages=clike+c+cpp+arduino */\n/**\n * okaidia theme for JavaScript, CSS and HTML\n * Loosely based on Monokai textmate theme by http://www.monokai.nl/\n * @author ocodia\n */\n\ncode[class*=\"language-\"],\npre[class*=\"language-\"] {\n\tcolor: #f8f8f2;\n\tbackground: none;\n\ttext-shadow: 0 1px rgba(0, 0, 0, 0.3);\n\tfont-family: Consolas, Monaco, 'Andale Mono', 'Ubuntu Mono', monospace;\n\ttext-align: left;\n\twhite-space: pre;\n\tword-spacing: normal;\n\tword-break: normal;\n\tword-wrap: normal;\n\tline-height: 1.5;\n\n\t-moz-tab-size: 4;\n\t-o-tab-size: 4;\n\ttab-size: 4;\n\n\t-webkit-hyphens: none;\n\t-moz-hyphens: none;\n\t-ms-hyphens: none;\n\thyphens: none;\n}\n\n/* Code blocks */\npre[class*=\"language-\"] {\n\tpadding: 1em;\n\tmargin: .5em 0;\n\toverflow: auto;\n\tborder-radius: 0.3em;\n}\n\n:not(pre) > code[class*=\"language-\"],\npre[class*=\"language-\"] {\n\tbackground: #272822;\n}\n\n/* Inline code */\n:not(pre) > code[class*=\"language-\"] {\n\tpadding: .1em;\n\tborder-radius: .3em;\n\twhite-space: normal;\n}\n\n.token.comment,\n.token.prolog,\n.token.doctype,\n.token.cdata {\n\tcolor: slategray;\n}\n\n.token.punctuation {\n\tcolor: #f8f8f2;\n}\n\n.namespace {\n\topacity: .7;\n}\n\n.token.property,\n.token.tag,\n.token.constant,\n.token.symbol,\n.token.deleted {\n\tcolor: #f92672;\n}\n\n.token.boolean,\n.token.number {\n\tcolor: #ae81ff;\n}\n\n.token.selector,\n.token.attr-name,\n.token.string,\n.token.char,\n.token.builtin,\n.token.inserted {\n\tcolor: #a6e22e;\n}\n\n.token.operator,\n.token.entity,\n.token.url,\n.language-css .token.string,\n.style .token.string,\n.token.variable {\n\tcolor: #f8f8f2;\n}\n\n.token.atrule,\n.token.attr-value,\n.token.function,\n.token.class-name {\n\tcolor: #e6db74;\n}\n\n.token.keyword {\n\tcolor: #66d9ef;\n}\n\n.token.regex,\n.token.important {\n\tcolor: #fd971f;\n}\n\n.token.important,\n.token.bold {\n\tfont-weight: bold;\n}\n.token.italic {\n\tfont-style: italic;\n}\n\n.token.entity {\n\tcursor: help;\n}\n\n", ""]);
